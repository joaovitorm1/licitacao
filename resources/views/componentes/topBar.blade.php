      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-primary navbar navbar-default navbar-fixed-top" >
        <div class="container">
          <a href="index3.html" class="navbar-brand">
            <img src="https://portoseguro.ba.gov.br/dist/img/logo-white.png" alt="AdminLTE Logo" width="150px;"  style="opacity: .8">
          ...
          <li class="">
                <a href="http://www.acessoinformacao.com.br/ba/portoseguro/" class="nav-link text-light">Transparência</a>
              </li>
          <li class="">
